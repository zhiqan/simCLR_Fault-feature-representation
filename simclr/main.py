...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default="E:\\研究数据\\西储大学\\xichu76lei_380")
    parser.add_argument('--feature_save_dir', type=str, default="E:\\研究数据\\西储大学\\xichu76lei_380")
